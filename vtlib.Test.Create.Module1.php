 ...
 * vtiger_taxreceipt  (taxreceiptid INTEGER)
 * vtiger_taxreceiptcf(taxreceiptid INTEGER PRIMARY KEY)
 * vtiger_taxreceiptgrouprel((taxreceiptid INTEGER PRIMARY KEY, groupname VARCHAR(100))
 */
...
$block1->label = 'LBL_TAXRECEIPT_INFORMATION';
...
$field1->name = 'taxreceiptname';
$field1->label = 'Tax Receipt';
$field1->table = $module->basetable;
$field1->column = 'taxreceiptname';
...
$field2->name = 'taxreceipttype';
$field2->label = 'Tax Receipt Type'; 
...
$field2->setPicklistValues( Array ('Sent', 'Printed','Accepted') );


$field3 = new Vtiger_Field();
$field3->name = 'ProductList';
$field3->table = 'vtiger_taxreceipt';
...
$field4->table = 'vtiger_taxreceipt';
...
$field8->table = 'vtiger_taxreceipt';
...
$field9->name = 'tr_sequence'; //Sequencial
$field9->label = 'Tax Receipt  Number';
$field9->table = 'vtiger_taxreceipt'; //$module->basetable;
$field9->column = 'tr_sequence';
...
$entity_tmp->setModuleSeqNumber("configure",$module->name,"TR",1);
...
$module->setRelatedList(Vtiger_Module::getInstance('Invoice'), 'Invoice', Array('ADD','SELECT'));
