...
//scott $pdf->addTextBlock( $org_name, $companyText ,$companyBlockPositions );
...
// totals
// scott $totalBlock=array("145","235","10", "110");
//scott $totalText=$app_strings["Subtotal"].":      ".$price_subtotal."\n".
//scott	   $app_strings["Tax"].":              ".$price_salestax."\n".
//scott	   $app_strings["Adjustment"].":  ".$price_adjustment."\n".
//scott	   $app_strings["Total"].":            ".$price_total;
//scott $pdf->addDescBlock($totalText, $app_strings["Total Due"], $totalBlock);

$blurbBlock=array("10","265","150", "60");
$blockText=$app_strings["DODetach_Info"];
$pdf->addDescBlock($blockText, $app_strings["Instructions"], $blurbBlock);
$imageBlock2=array("10","270","160","65");
$pdf->addImage("test/logo/stamp.jpg", $imageBlock2);
